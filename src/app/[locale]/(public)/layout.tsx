...
import { CategoryWidgetServer } from "@/components/home/category-widget-server";
  ...
  return (
    <>
      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-1 gap-6 px-4 lg:px-6">
        {/* Left rail — popular categories + top-5 picks (homepage only) */}
        <CategoryWidgetServer />
        <main className="min-w-0 flex-1">{children}</main>
        {/* Right rail — pharmacist consult (homepage only) */}
